  ...
  head: () => ({
    meta: [
      ...
      { title: "MixOrder" },
      {
        name: "description",
        content:
          "This application creates an exact replica of an existing application, preserving all design, functionality, and user experiences.",
      },
      ...
      { name: "twitter:description", content: "This application creates an exact replica of an existing application, preserving all design, functionality, and user experiences." },
